...
\hline
{\em messenger\/} & \ucd{meta.id;phys.particle} & unitless & string &{Messenger particle type ({\em e.g.\/}, ``photon'', ``cosmic-ray'', ``neutrino'')} & NO \\
\hline
