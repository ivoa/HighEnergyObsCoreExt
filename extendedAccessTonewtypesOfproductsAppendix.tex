...
{\small
\begin{verbatim}
SELECT o.obs_publisher_did, o.obs_id, s_ra, s_dec, s_fov, t_min,
t_max, energy_min, energy_max, access_url, access_format, 
...
If additional constraints are required, for instance on time, then we can add another set of columns to the {\tt ivoa.response} table, ({\em e.g.\/}\null) {\em resp\_t\_min\/} and {\em resp\_t\_max\/}, and constrain the time interval by adding a clause like:
{\small
\begin{verbatim}
...
\begin{verbatim}
SELECT o.obs_publisher_did, o.obs_id, s_ra, s_dec, s_fov, t_min,
t_max, energy_min, energy_max, access_url, access_format, scan_mode,
